                ...
                <aside class="lg:col-span-4 xl:col-span-3">
                    <div class="sticky top-20">
                        <div
                            ...
                            <h3 class="px-5 pt-5 pb-3 text-lg font-semibold text-slate-900 dark:text-white">Cookie Policies
                            </h3>
                ...
                <main class="lg:col-span-8 xl:col-span-9">
                    ...
                    <div
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                <h1 class="text-3xl md:text-4xl font-extrabold text-slate-900 mb-3 dark:text-white">Cookie
                                    Policy</h1>
